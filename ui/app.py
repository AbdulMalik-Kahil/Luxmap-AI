...
# Import the maps agent creation logic
from maps_agent.agent import create_maps_agent

# App configuration
APP_NAME = "maps_agent_ui"
...
async def run_agent_logic(prompt: str, session_id: str) -> Dict[str, Any]:
    """
    Instantiates and runs the Maps Agent, returning structured results.
...
def main():
    ...
    # Main UI
    st.title("🗺️ Google Maps Agent")
    st.markdown("Search for locations and get information from Google Maps using natural language.")
    ...
    if prompt := st.chat_input("Search for locations on Google Maps..."):
        ...
        with st.chat_message("assistant"):
            with st.spinner("🗺️ Searching Google Maps..."):
